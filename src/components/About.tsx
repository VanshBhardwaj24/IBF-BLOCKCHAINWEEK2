      ...
      <div className="pt-16 p-16 lg:pl-20 xl:pl-32 ">
        <div className="flex-col">
          ...
          <p className="leading-8 text-white text-lg xl:w-1/2 xl:text-xl">
            Get a headstart into Blockchain. The event features a complete
            Solidity bootcamp, Talks by Industry Experts, Smart Contract
            Compedition and Certifications. Only 80 students will get be
            selected to attend this event.
            <br />
            <br />
            Explore the latest career developments and chart a course for your
            future blockchain journey.
          </p>
        </div>
      </div>
      <Cards></Cards>
